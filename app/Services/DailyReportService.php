        ...
        return [
            ...
            'homeroom' => [
                ...
                'columns' => [
                    ...
                    ['key' => 'class', 'label' => 'Lớp'],
                    ['key' => 'lecturer', 'label' => 'Giảng viên'],
                    ['key' => 'attending_students', 'label' => 'SV dự'],
                    ['key' => 'incident', 'label' => 'Việc phát sinh', 'type' => 'incident'],
                    ['key' => 'is_notification', 'label' => 'Thông báo', 'type' => 'notification'],
                    ['key' => 'incident_detail', 'label' => 'Chi tiết sự việc'],
                ],
                'exportKey' => 'SINHHOAT',
                'exportCols' => ['employee', 'date', 'room', 'period', 'department', 'class', 'lecturer', 'attending_students', 'incident', 'is_notification', 'incident_detail'],
            ],
            'violations' => [
